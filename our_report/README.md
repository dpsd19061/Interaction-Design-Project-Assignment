...
**--> Αρχικά ο χρήστης ανοίγει την εφαρμογή και και το αυτοκίνητο**

![ScreenShot](s1.JPG)

**--> Στη συνέχεια πατάει το μεγάλο κουμπί για να συνδεθεί με το Bluetooth και επιλέγει να συνδεθεί με το αυτοκίνητο**

<img src="s2.1.jpg" width="450"><img src="s2.2.jpg" width="450">

**--> Επειτα επιλέγει ποιο σύστημα μετάδοσης κίνησης θέλει να δοκιμάσει. Στην συγκεκριμένη περίπτωση επιλέγει το All Wheel Drive**

<img src="s3.jpg" width="450">

**--> Τοποθετεί τις κινητήρες και μη κινητήριες μονάδες αν και όπου χρειάζεται**

![ScreenShot](s4.JPG)

**--> Η εφαρμογή ενημερώνει τον χρήστη για το πως πρέπει να βάλει όλες τις μονάδες. Ετσι μπορεί να σιγουρέψει οτι έχει τοποθετήσει όλα τα κομμάτια σωστά**

![ScreenShot](s5.JPG)

**--> Μετά τοποθετεί το εξωτερικό κέλυφος για προστασία και ομορφιά**

![ScreenShot](s6.JPG)

**--> Εφόσον επέλεξε το All Wheel Drive πρίν αναδύεται ένα νέο παράθυρο στο οποίο πρέπει να επιλέξει το ποσοστό δύναμης μπροστινών και πίσω τροχών. Στη συγκεκριμένη περίπτωση διαλέγει 4Χ4**

<img src="s7.jpg" width="450">

**--> Τέλος ο χρήστης οδηγά και πειραματίζεται με το αυτοκίνητο ελέγχοντάς το με το χειριστήριο της εφαρμογής**
...
**Επιπλέον παρατίθεται το [βίντεο παρουσίσασης του πρωτοτύπου](https://youtu.be/eiowmv5mU4Q) το οποίο ειναι ανεβασμένο στο YouTube ως μή-καταχωρισμένο**
...
--> Το εξωτερικό κέλυφος σχεδιάστηκε με το Blender και επίσης εκτυπώθηκε σε 3D εκτυπωτή.

...
--> Κατά το άνοιγμα της εφαρμογής, η πρώτη σελίδα της εφαρμογής που αντικρίζει ο χρήστης είανι το βασικό "hub" από το οποίο έχει πρόσβαση στις τρεις βασικές υποκατευθύνσεις (σύνδεση bluetooth και έλεγχος αυτοκινήτου, εκπαιδευτικό υλικό, about). 
